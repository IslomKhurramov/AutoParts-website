...
exports.like_view_group_list = ["product", "community", "member", "comment"];
exports.dislike_view_group_list = ["product", "community", "member", "comment"];
...
exports.lookup_auth_member_unliked = (mb_id) => {
  return {
    $lookup: {
      from: "dislikes",
      let: {
        local_dislike_item_id: "$_id",
        local_mb_id: mb_id,
        nw_my_favorite: true,
      },
      pipeline: [
        {
          $match: {
            $expr: {
              $and: [
                { $eq: ["$dislike_ref_id", "$$local_dislike_item_id"] },
                { $eq: ["$mb_id", "$$local_mb_id"] },
              ],
            },
          },
